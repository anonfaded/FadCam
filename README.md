...
> **Latest validated CI build — Run #70 — commit `650e456ce67f07b64a05cc06f1b1e2b1428110cd`**
>
> The two APK artifacts below were successfully generated by the release-grade Android validation pipeline and are currently available for download. They expire on **September 5, 2026** under the workflow's 7-day artifact retention policy.

| Build | Use | Download |
| --- | --- | --- |
| 🟢 **Default Debug APK** | Development, device testing, smoke testing | **[⬇️ Download APK](https://api.github.com/repos/Trendyzima/FadCam/actions/artifacts/9713781298/zip)** |
| 🔵 **Default Release APK** | Release-build validation / installation testing | **[⬇️ Download APK](https://api.github.com/repos/Trendyzima/FadCam/actions/artifacts/9713793585/zip)** |

### 🔐 Verified build information

| Artifact | Size | SHA-256 | Status |
| --- | ---: | --- | --- |
| `fadcam-default-debug-apk` | 199,274,968 bytes | `a504e1f3760abcc8a63b9fd2175cc1a2c5970dc8e148e389c8d109dba81fde59` | ✅ Passed CI |
| `fadcam-default-release-apk` | 162,867,061 bytes | `58e004150e39815c998ffbbfdb00503b3c05f6e6d51f1ad029de76c420ddde67` | ✅ Passed CI |

**[🧪 Open Build #70](https://github.com/Trendyzima/FadCam/actions/runs/33249022600)** · **[📦 View all artifacts](https://github.com/Trendyzima/FadCam/actions/runs/33249022600)** · **[🚀 Permanent Releases](https://github.com/Trendyzima/FadCam/releases)**

> [!IMPORTANT]
> These are **CI artifacts**, not permanent production releases. The Default Release APK is signed with an ephemeral CI validation key. For permanent/user distribution, use a production-signed APK attached to a GitHub Release.
...
```text
Commit: 650e456ce67f07b64a05cc06f1b1e2b1428110cd
Run:    70
