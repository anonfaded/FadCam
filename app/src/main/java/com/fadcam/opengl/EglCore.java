 ...
 * <p>
 * Based on Grafika's EglCore: https://github.com/google/grafika/blob/master/app/src/main/java/com/android/grafika/gles/EglCore.java
 */
public final class EglCore {
     ...
     * Prepares EGL display and context.
     * <p>
     * @param sharedContext The context to share, or null if none.
     * @param flags Configuration flags. May be {@link #FLAG_RECORDABLE} or {@link #FLAG_TRY_GLES3}.
     */
    ...
    private EGLConfig getConfig(int flags, int version) {
        ...
        // doesn't really help. It can also lead to a huge performance hit on some platforms.
        int[] attribList = {
                EGL14.EGL_RED_SIZE, 8,
                EGL14.EGL_GREEN_SIZE, 8,
                EGL14.EGL_BLUE_SIZE, 8,
                EGL14.EGL_ALPHA_SIZE, 8,
                //EGL14.EGL_DEPTH_SIZE, 16, // Depth buffer not needed for 2D rendering
    ...
    protected void finalize() throws Throwable {
        try {
            if (mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
                Log.w(TAG, "EglCore was not explicitly released -- state may be leaked");
                release();
            }
        } finally {
            super.finalize();
    ...
    /**
     * Calls eglSwapBuffers. Use this to display the result of rendering onto the screen.
     *
