...
public abstract class Constants {
    ...
    public static final String BROADCAST_ON_TORCH_STATE_CHANGED =
        "com.servalabs.cam.ON_TORCH_STATE_CHANGED";
    ...
    public static final String BROADCAST_ON_MIRROR_CHANGED =
        "com.servalabs.cam.ON_MIRROR_CHANGED";
    public static final String EXTRA_MIRROR_ENABLED = "com.servalabs.cam.EXTRA_MIRROR_ENABLED";
    ...
    public static final String BROADCAST_ON_ZOOM_CHANGED =
        "com.servalabs.cam.ON_ZOOM_CHANGED";
    public static final String EXTRA_BROADCAST_ZOOM_RATIO = "com.servalabs.cam.EXTRA_BROADCAST_ZOOM_RATIO";
    public static final String EXTRA_BROADCAST_PAN_X = "com.servalabs.cam.EXTRA_BROADCAST_PAN_X";
    public static final String EXTRA_BROADCAST_PAN_Y = "com.servalabs.cam.EXTRA_BROADCAST_PAN_Y";
    public static final String BROADCAST_ON_EXPOSURE_CHANGED =
        "com.servalabs.cam.ON_EXPOSURE_CHANGED";
    public static final String EXTRA_BROADCAST_EXPOSURE_COMPENSATION =
        "com.servalabs.cam.EXTRA_BROADCAST_EXPOSURE_COMPENSATION";
    public static final String BROADCAST_MOTION_LAB_DEBUG =
        "com.servalabs.cam.MOTION_LAB_DEBUG";
    ...
    public static final String INTENT_ACTION_SET_EXPOSURE_COMPENSATION =
        "com.servalabs.cam.ACTION_SET_EXPOSURE_COMPENSATION";
    public static final String INTENT_ACTION_TOGGLE_AE_LOCK =
        "com.servalabs.cam.ACTION_TOGGLE_AE_LOCK";
    public static final String INTENT_ACTION_SET_AF_MODE =
        "com.servalabs.cam.ACTION_SET_AF_MODE";
    public static final String INTENT_ACTION_TAP_TO_FOCUS =
        "com.servalabs.cam.ACTION_TAP_TO_FOCUS";
    public static final String INTENT_ACTION_SET_ZOOM_RATIO =
        "com.servalabs.cam.ACTION_SET_ZOOM_RATIO";
    public static final String INTENT_ACTION_SET_FRONT_VIDEO_MIRROR =
        "com.servalabs.cam.ACTION_SET_FRONT_VIDEO_MIRROR";
    public static final String INTENT_ACTION_START_PREVIEW_ONLY =
        "com.servalabs.cam.ACTION_START_PREVIEW_ONLY";
    public static final String INTENT_ACTION_STOP_PREVIEW_ONLY =
        "com.servalabs.cam.ACTION_STOP_PREVIEW_ONLY";

    // Extras for the above intents
    public static final String EXTRA_EXPOSURE_COMPENSATION =
        "com.servalabs.cam.EXTRA_EXPOSURE_COMPENSATION"; // int
    public static final String EXTRA_AE_LOCK = "com.servalabs.cam.EXTRA_AE_LOCK"; // boolean
    public static final String EXTRA_AF_MODE = "com.servalabs.cam.EXTRA_AF_MODE"; // int (CaptureRequest.CONTROL_AF_MODE
    // values)
    public static final String EXTRA_FRONT_VIDEO_MIRROR_ENABLED =
        "com.servalabs.cam.EXTRA_FRONT_VIDEO_MIRROR_ENABLED"; // boolean
    public static final String EXTRA_PREVIEW_ONLY_ACTIVE =
        "com.servalabs.cam.EXTRA_PREVIEW_ONLY_ACTIVE"; // boolean
    ...
    public static final String BROADCAST_EXTRA_CAMERA_TYPE_FROM =
        "com.servalabs.cam.EXTRA_CAMERA_TYPE_FROM";
    ...
    public static final String BROADCAST_EXTRA_CAMERA_TYPE_TO =
        "com.servalabs.cam.EXTRA_CAMERA_TYPE_TO";
    ...
    public static final String BROADCAST_EXTRA_SWITCH_ERROR_REASON =
        "com.servalabs.cam.EXTRA_SWITCH_ERROR_REASON";
    ...
    public static final String INTENT_ACTION_QUERY_SCREEN_RECORDING_STATE =
        "com.servalabs.cam.ACTION_QUERY_SCREEN_RECORDING_STATE";
    
    // Floating controls actions (from overlay)
    public static final String ACTION_START_SCREEN_RECORDING_FROM_OVERLAY =
        "com.servalabs.cam.ACTION_START_SCREEN_RECORDING_FROM_OVERLAY";
    ...
    public static final String EXTRA_SCREEN_RECORDING_MUTED =
        "com.servalabs.cam.EXTRA_SCREEN_RECORDING_MUTED";
    ...
    public static final String EXTRA_PAN_X = "com.servalabs.cam.EXTRA_PAN_X"; // float
    /** Pan offset Y for zoom: float -1.0 (full top) to +1.0 (full bottom), 0.0 = centre */
    public static final String EXTRA_PAN_Y = "com.servalabs.cam.EXTRA_PAN_Y"; // float
    ...
    public static final String INTENT_EXTRA_INITIAL_TORCH_STATE =
        "com.servalabs.cam.EXTRA_INITIAL_TORCH_STATE";
    /**
    ...
    public static final String INTENT_EXTRA_CAMERA_TYPE_SWITCH =
        "com.servalabs.cam.EXTRA_CAMERA_TYPE_SWITCH";

    public static final String RECORDING_DIRECTORY = "ServaCam";
    ...
    public static final String INTENT_ACTION_TOGGLE_RECORDING_TORCH =
        "com.servalabs.cam.TOGGLE_RECORDING_TORCH";
    public static final String INTENT_ACTION_CAPTURE_PHOTO =
        "com.servalabs.cam.CAPTURE_PHOTO";
    ...
    public static final String EXTRA_ORIGINAL_TEMP_SAF_URI_STRING =
        "com.servalabs.cam.EXTRA_ORIGINAL_TEMP_SAF_URI_STRING"; // For
    // SAF
    // processing
    // replacement
    // tracking
    ...
    public static final String ACTION_CAMERA_RESOURCE_AVAILABILITY =
        "com.servalabs.cam.ACTION_CAMERA_RESOURCE_AVAILABILITY";
    public static final String EXTRA_CAMERA_RESOURCES_AVAILABLE =
        "com.servalabs.cam.EXTRA_CAMERA_RESOURCES_AVAILABLE";
