...
public class ServaCamApplication extends Application implements LifecycleObserver {
    @Override
    ...
    public void onAppBackgrounded() {
        ...
        Intent intent = new Intent(this, com.servalabs.cam.services.RecordingService.class);
