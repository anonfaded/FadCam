package com.servalabs.cam.playback;
...
public class SeekableFragmentedMp4MediaSourceFactory {
     ...
     * (e.g. {@code /storage/emulated/0/Download/ServaCam/file.mp4}). If the
     ...
     * <pre>
     * content://...document/primary:Download/ServaCam/file.mp4
     * content://...document/XXXX-XXXX:ServaCam/file.mp4  (SD card)
     * </pre>
        ...
        try {
            ...
            if (externalDirs != null) {
                for (File dir : externalDirs) {
                    ...
                    // externalDirs paths: /storage/XXXX-XXXX/Android/data/com.servalabs.cam/files
