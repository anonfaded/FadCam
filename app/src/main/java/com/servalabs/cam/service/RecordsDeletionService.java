...
import com.servalabs.cam.data.VideoIndexRepository;
import com.servalabs.cam.utils.TrashManager;
...
public class RecordsDeletionService extends Service {
    ...
    public static final String ACTION_START_DELETE_SESSION = "com.servalabs.cam.action.START_DELETE_SESSION";
    public static final String ACTION_APPEND_TO_DELETE_SESSION = "com.servalabs.cam.action.APPEND_TO_DELETE_SESSION";
    public static final String ACTION_START_SAVE_SESSION = "com.servalabs.cam.action.START_SAVE_SESSION";
    public static final String ACTION_ACKNOWLEDGE_DELETE_COMPLETION = "com.servalabs.cam.action.ACKNOWLEDGE_DELETE_COMPLETION";
    public static final String ACTION_CANCEL_DELETE_SESSION = "com.servalabs.cam.action.CANCEL_DELETE_SESSION";
                    ...
                    synchronized (this) {
                        ...
                        if (latest != null) {
                            if (result.success) {
                                ...
                                VideoStatsCache.invalidateStats(com.servalabs.cam.SharedPreferencesManager.getInstance(this));
    ...
    private File resolveUniqueGalleryDestination(@Nullable String displayName) {
        String safeName = (displayName == null || displayName.trim().isEmpty())
                ? ("ServaCam_" + System.currentTimeMillis() + ".mp4")
                : displayName;
