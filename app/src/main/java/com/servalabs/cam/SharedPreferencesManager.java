...
import com.servalabs.cam.CameraType; // Ensure CameraType is imported
...
public class SharedPreferencesManager {
     ...
     */
    public com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode getStreamingMode() {
        String mode = sharedPreferences.getString(PREF_KEY_STREAMING_MODE, "STREAM_AND_SAVE");
        try {
            return com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode.valueOf(mode);
        } catch (IllegalArgumentException e) {
            return com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode.STREAM_AND_SAVE;
        }
    }
     ...
     */
    public void setStreamingMode(com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode mode) {
        sharedPreferences
            .edit()
    ...
    public static final String NOTIFICATION_PRESET_DEFAULT = "default"; // Default ServaCam notification
    ...
    public int getCurrentBitrate() {
        if (sharedPreferences.getBoolean("bitrate_mode_custom", false)) {
            ...
            return com.servalabs.cam.Utils.estimateBitrate(resolution, frameRate);
        }
    }
    ...
    public int getAppIconResId(String iconKey) {
        ...
        ) return com.servalabs.cam.R.mipmap.ic_launcher_black;
        if (
            Constants.APP_ICON_MINIMAL.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_minimal;
        if (
            Constants.APP_ICON_ALTERNATIVE.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_2;
        if (
            Constants.APP_ICON_FADED.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_faded;
        if (
            Constants.APP_ICON_PALESTINE.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_palestine;
        if (
        ...
        ) return com.servalabs.cam.R.mipmap.ic_launcher_bat;
        if (
            Constants.APP_ICON_REDBINARY.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_redbinary;
        if (
            Constants.APP_ICON_NOTES.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_notes;
        if (
            Constants.APP_ICON_CALCULATOR.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_calculator;
        if (
            Constants.APP_ICON_CLOCK.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_clock;
        if (
            Constants.APP_ICON_WEATHER.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_weather;
        if (
            Constants.APP_ICON_FOOTBALL.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_football;
        if (
            Constants.APP_ICON_CAR.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_car;
        if (
            Constants.APP_ICON_JET.equals(iconKey)
        ) return com.servalabs.cam.R.mipmap.ic_launcher_jet;
        // default or unknown
        return com.servalabs.cam.R.mipmap.ic_launcher;
    }
     ...
     * {@link com.servalabs.cam.dualcam.DualCameraConfig}.
     */
    public com.servalabs.cam.dualcam.DualCameraConfig getDualCameraConfig() {
        com.servalabs.cam.dualcam.DualCameraConfig.PipPosition pos;
        try {
            pos = com.servalabs.cam.dualcam.DualCameraConfig.PipPosition.valueOf(
                    sharedPreferences.getString(Constants.PREF_DUAL_CAMERA_PIP_POSITION, "BOTTOM_RIGHT"));
        } catch (IllegalArgumentException e) {
            pos = com.servalabs.cam.dualcam.DualCameraConfig.PipPosition.BOTTOM_RIGHT;
        }

        com.servalabs.cam.dualcam.DualCameraConfig.PipSize size;
        try {
            size = com.servalabs.cam.dualcam.DualCameraConfig.PipSize.valueOf(
                    sharedPreferences.getString(Constants.PREF_DUAL_CAMERA_PIP_SIZE, "MEDIUM"));
        } catch (IllegalArgumentException e) {
            size = com.servalabs.cam.dualcam.DualCameraConfig.PipSize.MEDIUM;
        }

        com.servalabs.cam.dualcam.DualCameraConfig.PrimaryCamera primary;
        try {
            primary = com.servalabs.cam.dualcam.DualCameraConfig.PrimaryCamera.valueOf(
                    sharedPreferences.getString(Constants.PREF_DUAL_CAMERA_PRIMARY, "BACK"));
        } catch (IllegalArgumentException e) {
            primary = com.servalabs.cam.dualcam.DualCameraConfig.PrimaryCamera.BACK;
        }
        ...
        return new com.servalabs.cam.dualcam.DualCameraConfig.Builder()
                .pipPosition(pos)
                .pipSize(size)
     ...
     */
    public void saveDualCameraConfig(@androidx.annotation.NonNull com.servalabs.cam.dualcam.DualCameraConfig config) {
        sharedPreferences.edit()
