package com.servalabs.cam.fadrec.ui.annotation;
...
public class AddObjectCommand implements DrawingCommand {
    ...
    public static AddObjectCommand fromJSON(AnnotationLayer layer, JSONObject json) 
        ...
        com.servalabs.cam.fadrec.ui.annotation.objects.AnnotationObject.ObjectType type = 
            com.servalabs.cam.fadrec.ui.annotation.objects.AnnotationObject.ObjectType.valueOf(typeStr);
        
        AnnotationObject object;
        switch (type) {
            case PATH:
                object = new com.servalabs.cam.fadrec.ui.annotation.objects.PathObject();
                break;
            case TEXT:
                object = new com.servalabs.cam.fadrec.ui.annotation.objects.TextObject();
                break;
            case SHAPE:
                object = new com.servalabs.cam.fadrec.ui.annotation.objects.ShapeObject();
                break;
            default:
