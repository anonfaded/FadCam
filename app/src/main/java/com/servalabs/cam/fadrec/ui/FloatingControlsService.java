...
public class FloatingControlsService extends Service {
    ...
    private void showQuickMenu() {
        ...
        snapGuidesSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            Intent intent = new Intent("com.servalabs.cam.fadrec.TOGGLE_SNAP_GUIDES");
        ...
        btnAddText.setOnClickListener(v -> {
            Intent intent = new Intent("com.servalabs.cam.fadrec.ADD_TEXT");
            sendBroadcast(intent);
        });
        
        // Add shape button
        btnAddShape.setOnClickListener(v -> {
            Intent intent = new Intent("com.servalabs.cam.fadrec.ADD_SHAPE");
            sendBroadcast(intent);
        });
