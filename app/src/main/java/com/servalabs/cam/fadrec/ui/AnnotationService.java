...
import com.servalabs.cam.fadrec.ui.annotation.AnnotationState;
import com.servalabs.cam.fadrec.ui.annotation.ProjectFileManager;
import com.servalabs.cam.fadrec.ui.overlay.BaseTransparentEditorActivity;
import com.servalabs.cam.fadrec.ui.annotation.AnnotationPage;
import com.servalabs.cam.fadrec.ui.annotation.AnnotationLayer;
import com.servalabs.cam.fadrec.ui.annotation.TextEditorDialog;
import com.servalabs.cam.fadrec.ui.annotation.ShapePickerDialog;
import com.servalabs.cam.fadrec.ui.annotation.objects.TextObject;
import com.servalabs.cam.fadrec.ui.annotation.objects.ShapeObject;
import com.servalabs.cam.fadrec.ui.overlay.BaseEditorOverlay;
import com.servalabs.cam.fadrec.ui.overlay.InlineTextEditor;
import com.servalabs.cam.fadrec.ui.overlay.TextEditorActivity;
...
public class AnnotationService extends Service {
    ...
    private com.servalabs.cam.fadrec.ScreenRecordingState recordingState = com.servalabs.cam.fadrec.ScreenRecordingState.NONE;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            if (!android.provider.Settings.canDrawOverlays(this)) {
                ...
                Intent errorBroadcast = new Intent("com.servalabs.cam.fadrec.ANNOTATION_SERVICE_PERMISSION_ERROR");
    ...
    private void showDeleteAllConfirmation(android.app.AlertDialog parentDialog) {
        Context themedContext = new ContextThemeWrapper(this, R.style.Base_Theme_ServaCam);
    ...
    private class ProjectListAdapter extends android.widget.ArrayAdapter<ProjectInfo> {
        ...
        private void showDeleteProjectConfirmation(String displayName, String folderName) {
            Context themedContext = new ContextThemeWrapper(AnnotationService.this, R.style.Base_Theme_ServaCam);
            MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(themedContext);
    ...
    public void onCreate() {
        ...
        new Thread(() -> {
            ...
            new Handler(Looper.getMainLooper()).post(() -> {
                ...
                Intent readyIntent = new Intent("com.servalabs.cam.fadrec.ANNOTATION_SERVICE_READY");
    ...
    private void setupToolbarListeners() {
        ...
        btnRecordingCollapsed.setOnClickListener(v -> {
            FLog.d(TAG, "Overlay button clicked - currentState: " + recordingState + ", NONE=" + com.servalabs.cam.fadrec.ScreenRecordingState.NONE + ", isEqual=" + (recordingState == com.servalabs.cam.fadrec.ScreenRecordingState.NONE));
            if (recordingState == com.servalabs.cam.fadrec.ScreenRecordingState.NONE) {
        ...
        btnStartStopRec.setOnClickListener(v -> {
            if (btnStartStopRec.isEnabled()) {
                ...
                Intent stopIntent = new Intent(this, com.servalabs.cam.fadrec.services.ScreenRecordingService.class);
                stopIntent.setAction(com.servalabs.cam.Constants.INTENT_ACTION_STOP_SCREEN_RECORDING);
        ...
        btnPauseResumeRec.setOnClickListener(v -> {
            if (btnPauseResumeRec.isEnabled()) {
                if (recordingState == com.servalabs.cam.fadrec.ScreenRecordingState.IN_PROGRESS) {
                    // Pause recording
                    FLog.d(TAG, "Pause button clicked - sending pause intent to service");
                    Intent pauseIntent = new Intent(this, com.servalabs.cam.fadrec.services.ScreenRecordingService.class);
                    pauseIntent.setAction(com.servalabs.cam.Constants.INTENT_ACTION_PAUSE_SCREEN_RECORDING);
                    startService(pauseIntent);
                } else if (recordingState == com.servalabs.cam.fadrec.ScreenRecordingState.PAUSED) {
                    // Resume recording
                    FLog.d(TAG, "Resume button clicked - sending resume intent to service");
                    Intent resumeIntent = new Intent(this, com.servalabs.cam.fadrec.services.ScreenRecordingService.class);
                    resumeIntent.setAction(com.servalabs.cam.Constants.INTENT_ACTION_RESUME_SCREEN_RECORDING);
            ...
            if (currentPage != null) {
                ...
                layerPanelOverlay.setOnLayerActionListener(new LayerPanelOverlay.OnLayerActionListener() {
                    ...
                    public void onLayerAdded() {
                        ...
                        com.servalabs.cam.fadrec.ui.annotation.AddLayerCommand command = new com.servalabs.cam.fadrec.ui.annotation.AddLayerCommand(
                    ...
                    public void onLayerDeleted(String layerId) {
                        ...
                        if (layerToDelete != null) {
                            ...
                            if (visibleLayers.size() > 1) {
                                ...
                                com.servalabs.cam.fadrec.ui.annotation.DeleteLayerCommand command = new com.servalabs.cam.fadrec.ui.annotation.DeleteLayerCommand(
    ...
    private Notification createNotification() {
        // Open app intent - tap notification to open ServaCam app
        Intent openAppIntent = getPackageManager().getLaunchIntentForPackage(getPackageName());
        if (openAppIntent == null) {
            openAppIntent = new Intent(this, com.servalabs.cam.MainActivity.class);
        }
    ...
    private void registerMenuActionReceiver() {
        menuActionReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (action) {
                    case "com.servalabs.cam.fadrec.TOGGLE_SNAP_GUIDES":
                    ...
                    case "com.servalabs.cam.fadrec.ADD_TEXT":
                        showTextEditorDialog();
                        break;

                    case "com.servalabs.cam.fadrec.ADD_SHAPE":
                        showShapePickerDialog();
                        break;
                }
            }
        ...
        filter.addAction("com.servalabs.cam.fadrec.TOGGLE_SNAP_GUIDES");
        filter.addAction("com.servalabs.cam.fadrec.ADD_TEXT");
        filter.addAction("com.servalabs.cam.fadrec.ADD_SHAPE");
    ...
    private void registerRecordingStateReceiver() {
        recordingStateReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (stateStr != null) {
                    try {
                        com.servalabs.cam.fadrec.ScreenRecordingState oldState = recordingState;
                        recordingState = com.servalabs.cam.fadrec.ScreenRecordingState.valueOf(stateStr);
                        FLog.d(TAG, "[BROADCAST] State updated: " + oldState + " -> " + recordingState);

                        // Handle timer based on state changes
                        if (recordingState == com.servalabs.cam.fadrec.ScreenRecordingState.IN_PROGRESS
                                && oldState != com.servalabs.cam.fadrec.ScreenRecordingState.IN_PROGRESS) {
                            // Recording started or resumed
                            FLog.d(TAG, "[BROADCAST] Starting timer due to state change");
                            startRecordingTimer();
                        } else if (recordingState == com.servalabs.cam.fadrec.ScreenRecordingState.NONE) {
        ...
        IntentFilter filter = new IntentFilter(com.servalabs.cam.Constants.BROADCAST_ON_SCREEN_RECORDING_STATE_CALLBACK);
    ...
    private void registerProjectSelectionReceiver() {
        ...
        IntentFilter layerRenameFilter = new IntentFilter("com.servalabs.cam.fadrec.RENAME_LAYER");
        ...
        IntentFilter pageRenameFilter = new IntentFilter("com.servalabs.cam.fadrec.RENAME_PAGE");
    ...
    private void handleTextEditorSave(Bundle resultData) {
        ...
        if (currentEditingTextObject != null) {
            ...
            if (containingLayer != null) {
                ...
                com.servalabs.cam.fadrec.ui.annotation.ModifyTextObjectCommand command = 
                    new com.servalabs.cam.fadrec.ui.annotation.ModifyTextObjectCommand(
            ...
            if (activeLayer != null && !activeLayer.isLocked()) {
                ...
                // CRITICAL: Use command pattern for undo/redo support
                com.servalabs.cam.fadrec.ui.annotation.AddObjectCommand command = 
                    new com.servalabs.cam.fadrec.ui.annotation.AddObjectCommand(activeLayer, textObject);
                currentPage.executeCommand(command);
    ...
    public void onDestroy() {
        ...
        Intent intent = new Intent("com.servalabs.cam.fadrec.ANNOTATION_SERVICE_STOPPED");
