package com.servalabs.cam.fadrec.services;
...
import com.servalabs.cam.fadrec.encoding.ScreenRecordingPipeline;
...
public class ScreenRecordingService extends Service {
    ...
    public void onCreate() {
        ...
        if (windowManager != null) {
            ...
            com.servalabs.cam.SharedPreferencesManager prefs = com.servalabs.cam.SharedPreferencesManager.getInstance(this);
    ...
    private void startScreenRecording() throws IOException {
        ...
        try {
            ...
            try {
                boolean serverOn = com.servalabs.cam.streaming.RemoteStreamManager.getInstance().isStreamingEnabled();
                com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode sessionMode =
                    sharedPreferencesManager.getStreamingMode();
                isStreamOnlySession = serverOn &&
                    (sessionMode == com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode.STREAM_ONLY);
            ...
            if (outputFile != null) {
                try {
                    com.servalabs.cam.streaming.RemoteStreamManager.getInstance().startRecording(outputFile);
     ...
     * Respects the same watermark settings as ServaCam mode.
     */
    ...
    private void stopScreenRecording() {
        ...
        try {
            ...
            if (isStreamOnly) {
                ...
                com.servalabs.cam.utils.StorageInfoCache.clearCache();
            }
        ...
        if (recordingWakeLock == null || !recordingWakeLock.isHeld()) {
            ...
            if (powerManager != null) {
                recordingWakeLock = powerManager.newWakeLock(
                    ...
                    "ServaCam:ScreenRecordingWakeLock"
                );
