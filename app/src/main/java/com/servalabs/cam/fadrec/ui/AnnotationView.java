...
import com.servalabs.cam.fadrec.ui.annotation.AddPathCommand;
...
import com.servalabs.cam.fadrec.ui.annotation.ClearLayerCommand;
import com.servalabs.cam.fadrec.ui.annotation.ClearAllLayersCommand;
import com.servalabs.cam.fadrec.ui.annotation.DrawingPath;
import com.servalabs.cam.fadrec.ui.annotation.objects.AnnotationObject;
import com.servalabs.cam.fadrec.ui.annotation.objects.PathObject;
...
public class AnnotationView extends View {
    ...
    public interface OnTextEditRequestListener {
        void onTextEditRequested(com.servalabs.cam.fadrec.ui.annotation.objects.TextObject textObject);
    }
    ...
    private void showTextEditDialog(com.servalabs.cam.fadrec.ui.annotation.objects.TextObject textObject) {
    ...
    private void drawSelectionHandles(Canvas canvas, AnnotationObject obj) {
        ...
        if (obj instanceof com.servalabs.cam.fadrec.ui.annotation.objects.TextObject) {
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (selectedObject != null) {
                        ...
                        if (selectedObject instanceof com.servalabs.cam.fadrec.ui.annotation.objects.TextObject) {
                        ...
                        if (distEdit < touchRadius) {
                            ...
                            showTextEditDialog((com.servalabs.cam.fadrec.ui.annotation.objects.TextObject) selectedObject);
                            return true;
