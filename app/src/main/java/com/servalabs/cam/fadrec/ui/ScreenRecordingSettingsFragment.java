 ...
 *
 * Orientation: isolated from ServaCam camera recording. Each mode remembers its own.
 */
public class ScreenRecordingSettingsFragment extends Fragment {
    ...
    private void refreshValues() {
        ...
        // Video splitting — uses shared prefs (same as ServaCam)
    ...
    // ── Video Splitting (reuses exact same logic & prefs as ServaCam) ──
