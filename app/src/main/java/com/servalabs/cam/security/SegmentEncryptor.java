package com.servalabs.cam.security;
...
public final class SegmentEncryptor {
     ...
     * @return Encrypted payload in the ServaCam E2E wire format.
    ...
    /**
     * Check whether the given bytes start with the ServaCam E2E magic bytes.
     *
