...
public class GLWatermarkRenderer {
    ...
    private com.servalabs.cam.opengl.grafika.FullFrameRect mFullFrameBlit = null;
    ...
    public void initializeEGL() {
        ...
        mFullFrameBlit = new com.servalabs.cam.opengl.grafika.FullFrameRect(
                new com.servalabs.cam.opengl.grafika.Texture2dProgram(
                        com.servalabs.cam.opengl.grafika.Texture2dProgram.ProgramType.TEXTURE_EXT));
    ...
    private void drawOESTexture(float[] mvpMatrix, float[] texMatrix) {
        try {
            ...
            if (mFullFrameBlit != null) {
                try {
                    com.servalabs.cam.opengl.grafika.Texture2dProgram program = mFullFrameBlit.getProgram();
                    if (program != null) {
                        try {
