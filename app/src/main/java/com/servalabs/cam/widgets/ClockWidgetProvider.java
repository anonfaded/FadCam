...
public class ClockWidgetProvider extends AppWidgetProvider {
    ...
    private static final String ACTION_UPDATE_CLOCK = "com.servalabs.cam.widgets.ACTION_UPDATE_CLOCK";
    ...
    float arabicDateSizeSp = Math.max(11f, Math.min(16f, 14f * dateScale));
        ...
        Intent launch = new Intent(context, com.servalabs.cam.MainActivity.class);
