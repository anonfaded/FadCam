package com.servalabs.cam.dualcam.service;
...
import com.servalabs.cam.dualcam.DualCameraConfig;
import com.servalabs.cam.dualcam.DualCameraState;
...
public class DualCameraRecordingService extends Service {
    ...
    private void startDualRecording() {
        ...
        try {
            ...
            int fps = prefs.getSpecificVideoFrameRate(
                    config.getPrimaryCamera() == DualCameraConfig.PrimaryCamera.BACK
                            ? com.servalabs.cam.CameraType.BACK : com.servalabs.cam.CameraType.FRONT);
            com.servalabs.cam.VideoCodec codec = prefs.getVideoCodec();
            ...
            WatermarkInfoProvider watermarkProvider = () -> {
                ...
                switch (watermarkOption) {
                    ...
                    case "badge_servacam":
                        return "Captured by" + customTextLine;
                    case "timestamp_servacam":
                    default:
                        return "Captured by - " + getDualCamTimestamp() + customTextLine;
                }
            };
    ...
    private void acquireWakeLock() {
        ...
        if (pm != null) {
            wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "ServaCam:DualCamRecording");
