...
public class ForensicsGalleryInfoBottomSheetFragment extends BottomSheetDialogFragment {

    public static ForensicsGalleryInfoBottomSheetFragment newInstance() {
        return new ForensicsGalleryInfoBottomSheetFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (title != null) {
            title.setText(R.string.forensics_info_title);
        }
        ...
        ViewGroup list = view.findViewById(R.id.picker_list_container);
        if (list != null) {
            list.removeAllViews();
            ...
            body.setText(getString(R.string.forensics_info_body));
            list.addView(body);
        }

        ImageView close = view.findViewById(R.id.picker_close_btn);
        if (close != null) {
