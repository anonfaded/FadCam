package com.servalabs.cam.forensics.ui;
...
import com.servalabs.cam.forensics.data.local.model.ForensicsSnapshotWithMedia;
import com.servalabs.cam.ui.ImageViewerActivity;
...
public class ForensicsGalleryFragment extends Fragment {
    ...
    @Nullable
    private com.servalabs.cam.ui.GalleryFastScroller fastScroller;
        ...
        executor.execute(() -> {
            ...
            for (ForensicsSnapshotWithMedia row : selectedRows) {
                ...
                boolean moved = TrashManager.moveToTrash(
                        ...
                        displayName,
                        false,
                        com.servalabs.cam.Constants.TRASH_SUBDIR_FORENSICS_EVIDENCE
                );
                if (moved) {
                    movedCount++;
