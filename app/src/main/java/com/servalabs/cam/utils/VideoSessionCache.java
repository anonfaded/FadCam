...
public class VideoSessionCache {
     ...
     */
    private static synchronized void initializeCacheIfNeeded(com.servalabs.cam.SharedPreferencesManager sharedPrefs) {
     ...
     */
    public static synchronized boolean hasCachedData(com.servalabs.cam.SharedPreferencesManager sharedPrefs) {
     ...
     */
    public static synchronized boolean hasCachedVideoCount(com.servalabs.cam.SharedPreferencesManager sharedPrefs) {
        initializeCacheIfNeeded(sharedPrefs);
     ...
     */
    public static synchronized void invalidateOnNextAccess(com.servalabs.cam.SharedPreferencesManager sharedPrefs) {
        sForceRefreshOnNextAccess = true;
     ...
     */
    public static synchronized int getCachedVideoCount(com.servalabs.cam.SharedPreferencesManager sharedPrefs) {
        initializeCacheIfNeeded(sharedPrefs);
        return sCachedVideoCount;
    }
     ...
     */
    public static synchronized void setCachedVideoCount(int count, com.servalabs.cam.SharedPreferencesManager sharedPrefs) {
        sCachedVideoCount = count;
