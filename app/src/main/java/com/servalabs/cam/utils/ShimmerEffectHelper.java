...
public class ShimmerEffectHelper {
    ...
    public static void applyShimmerEffect(View view) {
        ...
        try {
            ...
            view.setTag(com.servalabs.cam.R.id.shimmer_animator_tag, shimmerAnimator);
    ...
    public static void removeShimmerEffect(View view) {
        ...
        try {
            ...
            ValueAnimator animator = (ValueAnimator) view.getTag(com.servalabs.cam.R.id.shimmer_animator_tag);
            if (animator != null) {
                animator.cancel();
                view.setTag(com.servalabs.cam.R.id.shimmer_animator_tag, null);
            }
