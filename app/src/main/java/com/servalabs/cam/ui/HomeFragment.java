...
import com.servalabs.cam.RecordingControlIntents;
...
import com.servalabs.cam.services.RecordingService;
import com.servalabs.cam.services.TorchService;
import com.servalabs.cam.dualcam.service.DualCameraRecordingService;
import com.servalabs.cam.streaming.RemoteStreamManager;
import com.servalabs.cam.ui.helpers.HomeFragmentHelper;
...
import com.servalabs.cam.utils.StorageInfoCache;
import com.servalabs.cam.utils.VideoStatsCache;
...
public class HomeFragment extends BaseFragment {
    ...
    protected com.servalabs.cam.ui.utils.StorageProgressRingView storageProgressRing;
    ...
    private com.servalabs.cam.ui.utils.ElapsedCompactAnimatedView viewElapsedCompact;
    ...
    // private com.servalabs.cam.ui.CompactControlOverlay compactOverlay;
        ...
        if (!messageQueue.isEmpty()) {
            ...
            String themeName =
                sharedPreferencesManager.sharedPreferences.getString(
                    com.servalabs.cam.Constants.PREF_APP_THEME,
    ...
    public void onStart() {
        ...
        if (
            com.servalabs.cam.SharedPreferencesManager.isAutoUpdateCheckEnabled(
                requireContext()
            ) &&
                ...
                updateExecutor.execute(() -> {
                    try {
                        java.net.URL url = new java.net.URL(
                            "https://github.com/anonfaded/ServaCam/releases/latest"
                        );
            ...
            recordingCompleteReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (
                        ...
                        com.servalabs.cam.utils.VideoSessionCache.invalidateOnNextAccess();
                        FLog.d(
                            TAG,
    ...
    public void onViewCreated(
        ...
        getParentFragmentManager().setFragmentResultListener(
                ...
                (requestKey, bundle) -> {
                    ...
                    int sliderVal = bundle.getInt(
                        com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SLIDER_VALUE,
                        Integer.MIN_VALUE
                    );
                    FLog.d(
                        TAG,
                    ...
                    if (
                        !isMyServiceRunning(
                            com.servalabs.cam.services.RecordingService.class
                        )
                    ) {
                        FLog.d(
                            TAG,
                        ...
                        Intent i =
                            com.servalabs.cam.RecordingControlIntents.setExposureCompensation(
                                requireContext(),
                                currentEvIndex
                            );
        ...
        getParentFragmentManager().setFragmentResultListener(
                ...
                (requestKey, bundle) -> {
                    ...
                    if (
                        ...
                        Intent i =
                            com.servalabs.cam.RecordingControlIntents.toggleAeLock(
                                requireContext(),
                                aeLocked
                            );
                        requireActivity().startService(i);
        ...
        getParentFragmentManager().setFragmentResultListener(
                ...
                (requestKey, bundle) -> {
                    ...
                    if (
                        ...
                        Intent i = com.servalabs.cam.RecordingControlIntents.setAfMode(
                            requireContext(),
                            afMode
                        );
                        requireActivity().startService(i);
                    ...
                    try {
                        ...
                        if (
                            ...
                            if (
                                ...
                                Intent intent =
                                    com.servalabs.cam.RecordingControlIntents.setZoomRatio(
                                        requireContext(),
                                        zoomRatio
                                    );
        ...
        if (btnGetPro != null) {
            ...
            btnGetPro.setOnClickListener(v -> {
                ...
                try {
                    com.servalabs.cam.ui.utils.NewFeatureManager.markFeatureAsSeen(requireContext(), "pro");
                ...
                // Open ServaCam Pro Activity
                Intent intent = new Intent(getActivity(), ServaCamProActivity.class);
                startActivity(intent);
            });
    ...
    private void showDisplayOptionsDialog() {
        ...
        ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem(ids[0], labels[0], getString(R.string.home_clock_display_timeonly_desc), null, null, null, null, null, "schedule"));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(ids[1], labels[1], getString(R.string.home_clock_display_english_desc), null, null, null, null, null, "calendar_month"));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(ids[2], labels[2], getString(R.string.home_clock_display_islamic_desc), null, null, null, null, null, "event"));
    ...
    private void updateClock() {
        ...
        if (tvClock instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
            ((com.servalabs.cam.ui.utils.AnimatedTextView) tvClock).animateSlot(currentTime, 400);
        } else {
        ...
        if (tvDateEnglish instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
            ((com.servalabs.cam.ui.utils.AnimatedTextView) tvDateEnglish).animateSlot(displayDateEnglish, 400);
        } else {
    ...
    private void updateStorageUiWithCachedInfo(
        ...
        if (isRecording() || isPaused()) {
            ...
            try {
                ...
                com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode mode =
                    sharedPreferencesManager.getStreamingMode();
                isStreamOnlyMode = serverActive &&
                    (mode == com.servalabs.cam.streaming.RemoteStreamManager.StreamingMode.STREAM_ONLY);
            } catch (Exception e) {
        ...
        String cameraLabel = "";
        try {
            com.servalabs.cam.CameraType camType =
                sharedPreferencesManager.getCameraSelection();
            if (camType == com.servalabs.cam.CameraType.FRONT) {
            ...
            getActivity().runOnUiThread(() -> {
                    ...
                    if (!suppressDefaultCameraRowUpdates()) {
                        ...
                        if (tvCameraTitle != null) {
                            ...
                            if (!oldCamTitle.equals(finalCameraLabel)) {
                                if (animateCameraRow && tvCameraTitle instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                                    ((com.servalabs.cam.ui.utils.AnimatedTextView) tvCameraTitle).animateSlotFull(finalCameraLabel, 400);
                                } else {
                        ...
                        if (tvCameraSubtitle != null) {
                            ...
                            if (!oldCamSub.equals(cameraSubtitle)) {
                                if (animateCameraRow && tvCameraSubtitle instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                                    ((com.servalabs.cam.ui.utils.AnimatedTextView) tvCameraSubtitle).animateSlotFull(cameraSubtitle, 400);
                                } else {
                        ...
                        try {
                            ...
                            if (ivCameraIcon != null) {
                                ...
                                if (!oldIconText.equals(newIconText)) {
                                    if (animateCameraRow && ivCameraIcon instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                                        ((com.servalabs.cam.ui.utils.AnimatedTextView) ivCameraIcon)
                    ...
                    if (!suppressDefaultTimeLeftRowUpdates()) {
                        if (tvEstimateTitle != null) {
                            ...
                            if (!oldEstimate.equals(finalTimeLeftText)) {
                                if (tvEstimateTitle instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                                    ...
                                    if (formatChanged) {
                                        ((com.servalabs.cam.ui.utils.AnimatedTextView) tvEstimateTitle).animateSlotFullDown(finalTimeLeftText, 400);
                                    } else {
                                        ((com.servalabs.cam.ui.utils.AnimatedTextView) tvEstimateTitle).animateSlotDown(finalTimeLeftText, 400);
                                    }
                                } else {
                    ...
                    if (tvSpaceTitle != null) {
                        ...
                        if (!oldSpaceValue.equals(availableSpace)) {
                            if (tvSpaceTitle instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                                ((com.servalabs.cam.ui.utils.AnimatedTextView) tvSpaceTitle).animateSlotDown(availableSpace, 400);
                            } else {
                    ...
                    if (tvSpaceSubtitle != null) {
                        ...
                        if (tvSpaceSubtitle instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                            ((com.servalabs.cam.ui.utils.AnimatedTextView) tvSpaceSubtitle).animateSlot(newSubtitle, 400);
                        } else {
     ...
     * If the button is an {@link com.servalabs.cam.ui.utils.AnimatedMaterialButton}, the text label
    ...
    protected void applyButtonTransition(
        ...
        if (button instanceof com.servalabs.cam.ui.utils.AnimatedMaterialButton) {
            ((com.servalabs.cam.ui.utils.AnimatedMaterialButton) button).cancelAnimation();
        }
    ...
    protected void animateButtonTransition(
        ...
        if (button instanceof com.servalabs.cam.ui.utils.AnimatedMaterialButton) {
            com.servalabs.cam.ui.utils.AnimatedMaterialButton animated =
                    (com.servalabs.cam.ui.utils.AnimatedMaterialButton) button;
            if (iconChanged) {
    ...
    protected void renderElapsedDisplay(String elapsedTimeText, boolean allowAnimation) {
        ...
        if (!isElapsedDigitalDisplayMode() && viewElapsedCompact != null) {
            ...
            String oldElapsed = tvElapsedTitle.getText() != null
                    ...
                    : "";
            boolean animate = allowAnimation && shouldAnimateElapsedTransition(oldElapsed, elapsedTimeText);
            if (tvElapsedTitle instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                com.servalabs.cam.ui.utils.AnimatedTextView animated =
                        (com.servalabs.cam.ui.utils.AnimatedTextView) tvElapsedTitle;
                if (animate) {
    ...
    private void updateStats() {
        ...
        executorService.submit(() -> {
            ...
            try {
                com.servalabs.cam.data.VideoIndexRepository repo =
                ...
                if (isRecording) {
                    ...
                    long activeBytes = com.servalabs.cam.ActiveRecordingStats.getActiveFileSizeBytes(requireContext());
            ...
            if (com.servalabs.cam.utils.VideoSessionCache.isSessionCacheValid() && !isRecording) {
                FLog.d(
                    TAG,
                    "updateStats BG: Using shared session cache (" +
                    com.servalabs.cam.utils.VideoSessionCache.getSessionCachedVideos().size() +
                    " items) - eliminating duplicate scanning"
                );
                primaryItems = new ArrayList<>(
                    com.servalabs.cam.utils.VideoSessionCache.getSessionCachedVideos()
                );

                // CRITICAL FIX: Since we're using shared cache, populate it for future
                // cross-fragment use
                com.servalabs.cam.utils.VideoSessionCache.updateSessionCache(
                    primaryItems
                );
            } else {
                if (isRecording) {
            ...
            // rescanning
            if (!com.servalabs.cam.utils.VideoSessionCache.isSessionCacheValid()) {
                com.servalabs.cam.utils.VideoSessionCache.updateSessionCache(
                    primaryItems
                );
                com.servalabs.cam.utils.VideoSessionCache.setCachedVideoCount(
                    numVideos
                );
                FLog.d(
                    TAG,
    ...
    private void updateStatsUI(int numVideos, long totalSizeMB) {
        if (getActivity() != null) {
            ...
            getActivity().runOnUiThread(() -> {
                ...
                if (tvVideoCount instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                    ((com.servalabs.cam.ui.utils.AnimatedTextView) tvVideoCount).animateSlot(countText, 400);
                } else if (tvVideoCount != null) {
                    tvVideoCount.setText(countText);
                }

                // Used size — increases, animate UP.
                if (tvVideoSize instanceof com.servalabs.cam.ui.utils.AnimatedTextView) {
                    ((com.servalabs.cam.ui.utils.AnimatedTextView) tvVideoSize).animateSlot(totalSizeFormatted, 400);
    ...
    private void setupRecordingTiles(View root) {
        try {
            ...
            tileAfToggle.setOnClickListener(v -> {
                ...
                ArrayList<com.servalabs.cam.ui.picker.OptionItem> afItems =
                    new ArrayList<>();
                ...
                com.servalabs.cam.ui.picker.PickerBottomSheetFragment afSheet =
                    com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstance(
            ...
            tileExp.setOnClickListener(v -> {
                ...
                com.servalabs.cam.ui.picker.PickerBottomSheetFragment evSlider =
                    com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceSliderWithSwitch(
            ...
            tileZoom.setOnClickListener(v -> {
                ...
                com.servalabs.cam.ui.picker.PickerBottomSheetFragment zoomSlider =
                    com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceSliderZoom(
    ...
    private void dispatchCurrentPreviewZoomPan() {
        ...
        if (!isMyServiceRunning(com.servalabs.cam.services.RecordingService.class)) {
            return;
        }

        try {
            Intent zoomIntent = com.servalabs.cam.RecordingControlIntents.setZoomRatio(
                requireContext(),
                previewPinchZoomRatio,
                normalizedPanX,
                normalizedPanY
    ...
    private void showTorchOptionsDialog() {
        ...
        try {
            ...
            ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new ArrayList<>();
            if (hasBackTorch) {
                items.add(new com.servalabs.cam.ui.picker.OptionItem("back", getString(R.string.torch_back)));
            }
            if (hasFrontTorch) {
                items.add(new com.servalabs.cam.ui.picker.OptionItem("front", getString(R.string.torch_front)));
            }
            if (hasBackTorch && hasFrontTorch) {
                items.add(new com.servalabs.cam.ui.picker.OptionItem("both", getString(R.string.torch_both)));
            }
            ...
            getParentFragmentManager().setFragmentResultListener(resultKey, getViewLifecycleOwner(), (key, bundle) -> {
                String sel = bundle.getString(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SELECTED_ID);
                if (sel == null) return;
    ...
    // ── Header Logo Style (Default ServaCam text vs Animated Avatar) ──────────

    /**
     * Reads the header logo preference and swaps the header ImageView between
     * the static ServaCam logo and a small animated avatar that blinks.
                ...
                animatePressBounce(v, () -> {
                    ...
                    try {
                        if (getActivity() instanceof com.servalabs.cam.MainActivity) {
                            com.servalabs.cam.MainActivity act = (com.servalabs.cam.MainActivity) getActivity();
    ...
    private void captureShotFromCurrentPreview() {
        ...
        if (!isRecordingOrPaused()) {
            try {
                ...
                Intent shotIntent = new Intent(requireContext(), com.servalabs.cam.PhotoCaptureActivity.class);
    ...
    private void updateServiceWithCurrentSurface(
        ...
        if (isDualRecordingActive) {
            Intent dualIntent = new Intent(getContext(),
                    com.servalabs.cam.dualcam.service.DualCameraRecordingService.class);
            ...
            rowCamera.setOnClickListener(v -> {
                animatePressBounce(v, () -> {
                    ...
                    if (getActivity() != null) {
                        OverlayNavUtil.show(
                                getActivity(),
                                new com.servalabs.cam.ui.VideoSettingsFragment(),
    ...
    protected void updateStartStopButtonForFoldedState() {
        ...
        if (showTimerOnButton) {
            ...
            if (!currentValue.equals(latestElapsedDisplay)) {
                if (buttonStartStop instanceof com.servalabs.cam.ui.utils.AnimatedMaterialButton
                        && currentShowsTimer) {
                    com.servalabs.cam.ui.utils.AnimatedMaterialButton animatedButton =
                            (com.servalabs.cam.ui.utils.AnimatedMaterialButton) buttonStartStop;
    ...
    private void applyStorageIndicatorStylePreference() {
        ...
        if (STORAGE_INDICATOR_MICRO_PILL.equals(style)) {
            viewStyle = com.servalabs.cam.ui.utils.StorageProgressRingView.STYLE_MICRO_PILL_BAR;
        } else if (STORAGE_INDICATOR_VERTICAL_BAR.equals(style)) {
            viewStyle = com.servalabs.cam.ui.utils.StorageProgressRingView.STYLE_VERTICAL_BAR;
        } else {
            viewStyle = com.servalabs.cam.ui.utils.StorageProgressRingView.STYLE_RING;
        }
    ...
    private void updateHamburgerBadgeVisibility() {
        if (hamburgerBadgeDot != null) {
            try {
                boolean showBadge = com.servalabs.cam.ui.utils.NewFeatureManager.shouldShowBadge(requireContext(), "whats_new");
