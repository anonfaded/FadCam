...
import com.servalabs.cam.service.FileOperationService;
import com.servalabs.cam.ui.InputActionBottomSheetFragment;
...
public class TrashFragment extends BaseFragment implements TrashAdapter.OnTrashItemInteractionListener {
    ...
    private com.servalabs.cam.ui.utils.AnimatedTextView titleText;
    ...
    private void initializeViews(@NonNull View view) {
        ...
        if (backButton != null) {
            backButton.setOnClickListener(v -> {
                ...
                try { com.servalabs.cam.ui.OverlayNavUtil.dismiss(requireActivity()); } catch (Throwable ignored) {}
            });
        }
    ...
    private void setupRecyclerView() {
        ...
        trashAdapter.setOnMonthActionListener((monthKey, items) -> {
            ...
            List<com.servalabs.cam.model.TrashItem> selected = trashAdapter.getSelectedItems();
            boolean allSelected = true;
            for (com.servalabs.cam.model.TrashItem item : items) {
    ...
    private void refreshRecordsFragment() {
        ...
        if (!refreshSuccess) {
            try {
                Intent intent = new Intent(com.servalabs.cam.Constants.ACTION_FILES_RESTORED);
