...
public class FullscreenPreviewActivity extends AppCompatActivity {
    ...
    private void applyRuntimeTheme() {
        ...
        switch (theme) {
            ...
            case "Shadow Alloy":  styleRes = R.style.Theme_ServaCam_ShadowAlloy;  break;
            case "Pookie Pink":   styleRes = R.style.Theme_ServaCam_PookiePink;   break;
            case "Snow Veil":     styleRes = R.style.Theme_ServaCam_SnowVeil;     break;
            case "Crimson Bloom":
            default:              styleRes = R.style.Theme_ServaCam_Red;          break;
        }
        setTheme(styleRes);
    }
