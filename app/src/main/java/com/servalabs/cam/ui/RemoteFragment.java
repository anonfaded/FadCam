...
import com.servalabs.cam.streaming.RemoteAuthManager;
import com.servalabs.cam.streaming.RemoteStreamManager;
import com.servalabs.cam.streaming.RemoteStreamService;
import com.servalabs.cam.streaming.model.StreamQuality;
import com.servalabs.cam.streaming.util.NetworkMonitor;
import com.servalabs.cam.security.StreamKeyManager;
import com.servalabs.cam.ui.bottomsheet.BatteryInfoBottomSheet;
import com.servalabs.cam.ui.bottomsheet.QualityPresetBottomSheet;
import com.servalabs.cam.ui.bottomsheet.UptimeInfoBottomSheet;
...
public class RemoteFragment extends BaseFragment {
    ...
    private com.servalabs.cam.ui.utils.StorageProgressRingView batteryProgressRing;
    private com.servalabs.cam.ui.utils.StorageProgressRingView remoteStorageProgressRing;
    private com.servalabs.cam.ui.utils.StorageProgressRingView remoteMemoryProgressRing;
    ...
    private void updateServerHealth() {
        ...
        com.servalabs.cam.streaming.model.NetworkHealth networkHealth = manager.getNetworkHealth();
    ...
    private void updateRequirementsDisplay() {
        ...
        android.content.SharedPreferences prefs = requireContext().getSharedPreferences("ServaCamPrefs", android.content.Context.MODE_PRIVATE);
    ...
    private void showRecordingModePicker() {
        ...
        com.servalabs.cam.ui.picker.PickerBottomSheetFragment picker = 
