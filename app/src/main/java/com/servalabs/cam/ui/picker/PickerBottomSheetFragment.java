package com.servalabs.cam.ui.picker;
...
public class PickerBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    private com.servalabs.cam.ui.AvatarToggleView switchRef;
    ...
    items = new ArrayList<>();
        ...
        try {
            if (
                ...
                boolean saved = com.servalabs.cam.SharedPreferencesManager.getInstance(
                    requireContext()
                ).isAeLockedSaved();
                switchState = saved;
        ...
        if (switchPresent) {
            ...
            com.servalabs.cam.ui.AvatarToggleView swc = root.findViewById(
                R.id.picker_switch
            );
                ...
                swc.setOnCheckedChangeListener((button, checked) -> {
                    ...
                    try {
                        if ("Enable Video Splitting".equals(switchTitle)) {
                            com.servalabs.cam.SharedPreferencesManager.getInstance(requireContext()).setVideoSplittingEnabled(checked);
                        } else if ("Lock AE".equals(switchTitle)) {
                            // Also persist AE lock state directly for immediate consistency
                            com.servalabs.cam.SharedPreferencesManager.getInstance(requireContext()).setSavedAeLock(checked);
                    ...
                    String switchResultKey = "Lock AE".equals(switchTitle) ? com.servalabs.cam.Constants.RK_AE_LOCK : resultKey;
        ...
        if (gridMode) {
            ...
            for (OptionItem item : items) {
                ...
                com.servalabs.cam.ui.AvatarToggleView itemSwitch =
    ...
    private void applyInitialDateFormatDependency() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ("show_date".equals(tag)) {
                com.servalabs.cam.ui.AvatarToggleView dateSwitch =
    ...
    private void applyInitialArabicDateFormatDependency() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ("arabic_date".equals(tag)) {
                com.servalabs.cam.ui.AvatarToggleView arabicDateSwitch =
                    child.findViewById(R.id.picker_item_switch);
    ...
    private void applyThemedSwitchColors(@Nullable com.servalabs.cam.ui.AvatarToggleView swc) {
