...
public class AppearanceSettingsFragment extends Fragment {
    ...
    private void showAppIconSelectionDialog(TextView valueView) {
        ...
        com.servalabs.cam.ui.picker.PickerBottomSheetFragment sheet =
            com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceGrid(
    ...
    private void updateAppIcon(String iconKey) {
        ...
        ComponentName alternativeIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.AlternativeIcon"
        );
        ComponentName fadedIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.FadedIcon"
        );
        ComponentName palestineIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.PalestineIcon"
        );
        ...
        ComponentName noorIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.NoorIcon"
        );
        ComponentName batIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.BatIcon"
        );
        ComponentName redbinaryIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.RedBinaryIcon"
        );
        ComponentName notesIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.NotesIcon"
        );
        ComponentName calculatorIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.CalculatorIcon"
        );
        ComponentName clockIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.ClockIcon"
        );
        ComponentName weatherIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.WeatherIcon"
        );
        ComponentName footballIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.FootballIcon"
        );
        ComponentName carIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.CarIcon"
        );
        ComponentName jetIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.JetIcon"
        );
        ComponentName minimalIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.MinimalIcon"
        );
        ComponentName blackIcon = new ComponentName(
            requireContext(),
            "com.servalabs.cam.MainActivity.BlackIcon"
        );
        ...
        try {
            com.servalabs.cam.shortcuts.ShortcutsManager sm =
                new com.servalabs.cam.shortcuts.ShortcutsManager(requireContext());
            sm.refreshShortcuts();
    ...
    private void showLogoPicker(TextView value) {
        ...
        com.servalabs.cam.ui.picker.PickerBottomSheetFragment sheet =
                com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceGradient(
                        ...
                        true);
        // Enable avatar icon rendering; ServaCam logo uses default static icon.
        if (sheet.getArguments() != null) {
            sheet.getArguments().putBoolean(
                    com.servalabs.cam.ui.picker.PickerBottomSheetFragment.ARG_BROWSE_MODE, true);
        }
    ...
    private void showEyeColorPicker(TextView valueView, @Nullable View swatch) {
        ...
        getParentFragmentManager().setFragmentResultListener(
                resultKey, this, (k, b) -> {
                    ...
                    if (b.containsKey(
                            com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_PREVIEW_ID)) {
        ...
        if (sheet.getArguments() != null) {
            sheet.getArguments().putBoolean(
                    com.servalabs.cam.ui.picker.PickerBottomSheetFragment.ARG_BROWSE_MODE, true);
            sheet.getArguments().putBoolean(
                    com.servalabs.cam.ui.picker.PickerBottomSheetFragment.ARG_AVATAR_SWATCH, true);
        }
