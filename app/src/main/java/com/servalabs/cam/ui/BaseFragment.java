...
public abstract class BaseFragment extends Fragment {
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(getViewLifecycleOwner(), 
            ...
            public void handleOnBackPressed() {
                ...
                if (!onBackPressed()) {
                    ...
                    try {
                        if (requireActivity() instanceof com.servalabs.cam.MainActivity) {
                            com.servalabs.cam.MainActivity mainActivity = (com.servalabs.cam.MainActivity) requireActivity();
    ...
    public void onDestroyView() {
        ...
        if(getActivity() instanceof com.servalabs.cam.MainActivity){
            FLog.d("OverlayDebug","BaseFragment onDestroyView fragment="+getClass().getSimpleName()+" backStackBefore="+getActivity().getSupportFragmentManager().getBackStackEntryCount());
            ((com.servalabs.cam.MainActivity) getActivity()).hideOverlayIfNoFragments();
        }
    }
} 