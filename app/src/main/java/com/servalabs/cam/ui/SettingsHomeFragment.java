...
public class SettingsHomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Request focus on first focusable view for D-pad navigation (TV support)
        root.post(() -> {
            View firstFocusable = findFirstFocusableView(root.findViewById(R.id.group_video_quick));
    ...
    private void setupRowHandlers(View root) {
        ...
        bindRow(root, R.id.group_screen_recording, () -> openSubFragment(new com.servalabs.cam.fadrec.ui.ScreenRecordingSettingsFragment()));
