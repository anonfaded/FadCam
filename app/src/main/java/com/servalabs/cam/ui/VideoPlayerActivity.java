...
public class VideoPlayerActivity extends AppCompatActivity {
    ...
    private static final String ACTION_PLAYBACK_POSITION_UPDATED =
        "com.servalabs.cam.ACTION_PLAYBACK_POSITION_UPDATED";
    ...
    private com.servalabs.cam.ui.custom.AudioWaveformView audioWaveformView;
            ...
            try {
                ...
                if (isPlaying) {
                    ...
                    if (Math.abs(pos - lastSavedPos) > 1000) {
                        ...
                        com.servalabs.cam.playback.PlayerHolder holder =
                            com.servalabs.cam.playback.PlayerHolder.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.servalabs.cam.R.layout.activity_video_player);
        
        // Ensure hardware volume buttons control media (STREAM_MUSIC) volume
        setVolumeControlStream(AudioManager.STREAM_MUSIC);

        playerView = findViewById(com.servalabs.cam.R.id.player_view);
        backButton = findViewById(com.servalabs.cam.R.id.back_button);
        infoButton = findViewById(com.servalabs.cam.R.id.info_button);
        resetZoomButton = findViewById(com.servalabs.cam.R.id.reset_zoom_button);
    ...
    try { 
        ...
        Uri videoUri = getIntent().getData();
            ...
            final long requestedSeekMs = getIntent().getLongExtra(
                com.servalabs.cam.forensics.ui.ForensicsEventsFragment.EXTRA_OPEN_AT_MS,
                -1L
            );
            openPausedFromForensics = getIntent().getBooleanExtra(
                com.servalabs.cam.forensics.ui.ForensicsEventsFragment.EXTRA_OPEN_PAUSED,
                false
            );
                ...
                public void onValueChange(com.google.android.material.slider.Slider slider, float value, boolean fromUser) {
                    ...
                    try {
                        ...
                        if (dur > 0 && dur != C.TIME_UNSET) {
                            ...
                            com.servalabs.cam.playback.PlayerHolder holder = com.servalabs.cam.playback.PlayerHolder.getInstance();
                ...
                (key, bundle) -> {
                    if (
                        ...
                        if (spm != null) {
                            ...
                            com.servalabs.cam.ui.custom.AudioWaveformView waveformView =
        ...
        getSupportFragmentManager().setFragmentResultListener(
                ...
                (key, bundle) -> {
                    ...
                    if ("row_playback_speed".equals(sel)) {
                        ...
                        getSupportFragmentManager().setFragmentResultListener(
                                ...
                                (rkRes, resBundle) -> {
                                    ...
                                    if ("t_custom".equals(sel2)) {
                                        ...
                                        com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment num =
                                            com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.newInstance(
                                                getString(
                                        ...
                                        _b.putString(
                                            com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.ARG_DESCRIPTION,
                                            getString(
                                                R.string.timer_custom_description
                                            )
                                        );
                                        _b.putBoolean(
                                            com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.ARG_ENABLE_TIMER_CALC,
                                            true
                                        );
                                        num.setArguments(_b);
                                        ...
                                        getSupportFragmentManager().setFragmentResultListener(
                                                ...
                                                (rkN, nb) -> {
                                                    int minutes = nb.getInt(
                                                        com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER,
                                                        0
                                                    );
                                                    if (minutes > 0) {
                                                        int seconds =
                        ...
                        sheetCtrl.getArguments().putBoolean(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.ARG_STRICT_ITEMS_ONLY, true);
                        ...
                        getSupportFragmentManager().setFragmentResultListener(RK, this, (rkRes, b) -> {
                            ...
                            if ("c_custom".equals(s)) {
                                ...
                                com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment num = com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.newInstance(getString(R.string.timer_custom_title), 1, 86400, 1, getString(R.string.universal_enter_number), 5, 60, getString(R.string.timer_custom_low_hint), getString(R.string.timer_custom_high_hint), RK_NUM);
                                android.os.Bundle _b = num.getArguments() != null ? num.getArguments() : new android.os.Bundle();
                                _b.putString(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.ARG_DESCRIPTION, getString(R.string.controls_hide_delay_helper));
                                num.setArguments(_b);
                                ...
                                getSupportFragmentManager().setFragmentResultListener(RK_NUM, this, (rkn, nb) -> {
                                    int val = nb.getInt(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER, 0);
                                    if (val > 0) {
            ...
            if (bg && isPlaying && hasPostNotificationsPermission()) {
                ...
                try {
                    android.content.Intent svc = new android.content.Intent(
                        this,
                        com.servalabs.cam.services.PlaybackService.class
                    )
                        .setAction(
                            com.servalabs.cam.services.PlaybackService.ACTION_START
                        )
                        .putExtra(
                            com.servalabs.cam.services.PlaybackService.EXTRA_URI,
                            getIntent().getData()
                        )
                        .putExtra(
                            com.servalabs.cam.services.PlaybackService.EXTRA_SPEED,
                            player.getPlaybackParameters().speed
                        )
                        .putExtra(
                            com.servalabs.cam.services.PlaybackService.EXTRA_MUTED,
                            player.getVolume() == 0f
                        )
                        .putExtra(
                            com.servalabs.cam.services.PlaybackService.EXTRA_POSITION_MS,
                            player.getCurrentPosition()
                        )
                        .putExtra(
                            com.servalabs.cam.services.PlaybackService.EXTRA_PLAY_WHEN_READY,
                            true
                        )
                        .putExtra(
                            com.servalabs.cam.services.PlaybackService.EXTRA_FORCE_SHOW_NOTIFICATION,
                            true
                        );
                ...
                try {
                    android.content.Intent stop = new android.content.Intent(
                        ...
                        com.servalabs.cam.services.PlaybackService.ACTION_STOP
                    );
                    startService(stop);
                } catch (Exception ignored) {}
                FLog.d(
    ...
    protected void onDestroy() {
        ...
        try {
            android.content.Intent stop = new android.content.Intent(
                this,
                com.servalabs.cam.services.PlaybackService.class
            ).setAction(com.servalabs.cam.services.PlaybackService.ACTION_STOP);
            startService(stop);
        } catch (Exception ignored) {}
    ...
    private MaterialAlertDialogBuilder themedDialogBuilder() {
        int dialogTheme = R.style.ThemeOverlay_ServaCam_Dialog;
