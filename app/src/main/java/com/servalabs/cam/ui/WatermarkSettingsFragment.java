...
public class WatermarkSettingsFragment extends Fragment {
    ...
    private void showWatermarkStyleBottomSheet(){
        ...
        getParentFragmentManager().setFragmentResultListener(resultKey, this, (k,b)->{
            if(b.containsKey(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SELECTED_ID)){
                String id = b.getString(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SELECTED_ID);
                if(id!=null){
    ...
    private void showLocationFormatBottomSheet(){
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem("coordinates", getString(R.string.location_format_coordinates), (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("address", getString(R.string.location_format_address), (String) null));
    ...
    private void showLocationIntervalBottomSheet(){
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem("1000", "1 second (minimum — respects Nominatim API rate limit)", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("2000", "2 seconds", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("5000", "5 seconds (Default)", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("10000", "10 seconds", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("15000", "15 seconds", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("30000", "30 seconds", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("60000", "1 minute", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("180000", "3 minutes", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("300000", "5 minutes", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("600000", "10 minutes", (String) null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("3600000", "1 hour", (String) null));
