...
public class VideoPlayerSettingsFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        float defaultPlayback = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ).sharedPreferences.getFloat("pref_default_playback_speed", 1.0f);
        subPlayback.setText(getPlaybackLabel(defaultPlayback));
        float quick = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ).getQuickSpeed();
        subQuick.setText(formatSpeed(quick));
        // Seek amount subtitle
        int seekSec = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ...
        boolean muted = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ).isPlaybackMuted();
        subMute.setText(
            muted
        ...
        boolean waveformEnabled =
            com.servalabs.cam.SharedPreferencesManager.getInstance(
                requireContext()
        ...
        boolean keepOn = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ...
        boolean bg = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ...
        if (subBgTimer != null) {
            int savedSeconds = com.servalabs.cam.SharedPreferencesManager.getInstance(
                requireContext()
        ...
        if (subControllerTimeout != null) {
            int ctrlSeconds = com.servalabs.cam.SharedPreferencesManager.getInstance(
                requireContext()
        ...
        if (rowBgTimer != null) rowBgTimer.setOnClickListener(v -> {
            boolean bgEnabled = com.servalabs.cam.SharedPreferencesManager.getInstance(
                requireContext()
            ).isBackgroundPlaybackEnabled();
            if (!bgEnabled) {
    ...
    private void showControllerTimeoutPicker() {
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items =
        ...
        int cur = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ).getPlayerControlsTimeoutSeconds();
    ...
    private void showKeepScreenOnSwitchSheet() {
        ...
        boolean enabled = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ).isPlayerKeepScreenOn();
        getParentFragmentManager().setFragmentResultListener(
                RK,
        ...
        com.servalabs.cam.ui.picker.PickerBottomSheetFragment sheet =
            com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceWithSwitch(
    ...
    private void showBackgroundPlaybackSwitchSheet() {
        ...
        com.servalabs.cam.ui.picker.PickerBottomSheetFragment sheet =
            com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceWithSwitchDependencies(
    ...
    private void showPlaybackSpeedPicker() {
        ...
        float current = com.servalabs.cam.SharedPreferencesManager.getInstance(
            requireContext()
        ).sharedPreferences.getFloat("pref_default_playback_speed", 1.0f);
