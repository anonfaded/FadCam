...
public class SecuritySettingsFragment extends Fragment {
    ...
    private void showAppLockConfigDialog() {
        ...
        if(!isEnrolled){
            items.add(new com.servalabs.cam.ui.picker.OptionItem("set_pin_enable", getString(R.string.applock_set_pin_enable)));
        } else {
            items.add(new com.servalabs.cam.ui.picker.OptionItem("change_pin", getString(R.string.applock_change_pin)));
            items.add(new com.servalabs.cam.ui.picker.OptionItem("remove_pin", getString(R.string.applock_remove_pin)));
        }

        getParentFragmentManager().setFragmentResultListener(resultKey, this, (requestKey, bundle) -> {
            if(bundle.containsKey(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE)){
                boolean newState = bundle.getBoolean(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE);
                handleEnableDisable(newState);
            }
            if(bundle.containsKey(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SELECTED_ID)){
                String action = bundle.getString(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SELECTED_ID);
                if(action!=null){
                    switch(action){
                        case "set_pin_enable":
    ...
    if(showSwitch){
        ...
        for(com.servalabs.cam.ui.picker.OptionItem oi: items){ deps.add(oi.id); }
        sheet = com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceWithSwitchDependencies(
            ...
            sheet = com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstance(
                    getString(R.string.applock_dialog_title),
                    items,
                    null,
                    resultKey,
    ...
    private void showCloakRecentsConfig() {
        ...
        getParentFragmentManager().setFragmentResultListener(resultKey, this, (requestKey, bundle) -> {
            if(bundle.containsKey(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE)){
                boolean state = bundle.getBoolean(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE);
                ...
                try {
                    ...
                    if (act instanceof com.servalabs.cam.MainActivity) {
                        ((com.servalabs.cam.MainActivity) act).applyCloakPreferenceNow(state);
                    }
    ...
    private void showPrivacyBlackConfig() {
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem("exit_methods", getString(R.string.privacy_black_gestures_title), null, null, null, R.drawable.ic_arrow_right, false, false, null));
    ...
    private void showPrivacyBlackGesturesConfig() {
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem("gesture_swipe", getString(R.string.privacy_black_gesture_swipe), null, null, null, null, true, sharedPreferencesManager.isPrivacyBlackSwipeUpEnabled(), null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("gesture_triple", getString(R.string.privacy_black_gesture_triple), null, null, null, null, true, sharedPreferencesManager.isPrivacyBlackTripleTapEnabled(), null));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("gesture_long", getString(R.string.privacy_black_gesture_long), null, null, null, null, true, sharedPreferencesManager.isPrivacyBlackLongPressEnabled(), null));
    ...
    private void revertSwitchUIAfterCancel(){
        ...
        if(existing instanceof com.servalabs.cam.ui.picker.PickerBottomSheetFragment){
            ((com.servalabs.cam.ui.picker.PickerBottomSheetFragment) existing).dismiss();
        }
