...
import com.servalabs.cam.dualcam.DualCameraCapability;
import com.servalabs.cam.dualcam.ui.DualCameraSettingsFragment;
...
import com.servalabs.cam.utils.CameraXFrameRateUtil;
...
public class VideoSettingsFragment extends Fragment {
    ...
    private void showLocationEmbedSheet() {
        ...
        getParentFragmentManager().setFragmentResultListener(rk, this, (k, b) -> {
            if (b.containsKey(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE)) {
                boolean enabled = b.getBoolean(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE);
                if (enabled) {
        ...
        ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new ArrayList<>(); // no options, switch only
    ...
    private void showCameraBottomSheet() {
        ...
        items.add(new com.servalabs.cam.ui.picker.OptionItem(CameraType.FRONT.toString(),
                getString(R.string.button_settings_cam_front)));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(CameraType.BACK.toString(),
                getString(R.string.button_settings_cam_back)));
        ...
        if (dualCap.isSupported()) {
            items.add(new com.servalabs.cam.ui.picker.OptionItem(CameraType.DUAL_PIP.toString(),
    ...
    private void showLensBottomSheet() {
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>();
        for (CameraIdInfo info : availableBackCameras) {
            items.add(new com.servalabs.cam.ui.picker.OptionItem(info.id, info.displayName));
        }
    ...
    private void showResolutionBottomSheet() {
        ...
        for (Size s : resolutions) {
            ...
            items.add(new com.servalabs.cam.ui.picker.OptionItem(id, title));
        }
    ...
    private void showFrameRateBottomSheet() {
        ...
        for (Integer r : rates) {
            items.add(new com.servalabs.cam.ui.picker.OptionItem(String.valueOf(r), r + " fps"));
        }
    ...
    private void showCodecBottomSheet() {
        ...
        for (VideoCodec c : codes) {
            items.add(new com.servalabs.cam.ui.picker.OptionItem(c.toString(), c.toString()));
        }
    ...
    private void showBitrateBottomSheet() {
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem("auto", "Auto"));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("custom", "Custom (" + currentValueMbps + " Mbps)"));
    ...
    private void showBitrateCustomInput() {
        ...
        getParentFragmentManager().setFragmentResultListener(resultKey, this, (k, b) -> {
            if (b.containsKey(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER)) {
                int val = b.getInt(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER);
        ...
        com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment sheet = com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment
                .newInstance(
    ...
    private void showOrientationBottomSheet() {
        ...
        items.add(new com.servalabs.cam.ui.picker.OptionItem(SharedPreferencesManager.ORIENTATION_PORTRAIT,
                getString(R.string.video_orientation_portrait)));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(SharedPreferencesManager.ORIENTATION_LANDSCAPE,
                getString(R.string.video_orientation_landscape)));
    ...
    private List<Size> getCompatiblesVideoResolutions(CameraType type) {
        ...
        // FIX: Remove CamcorderProfile requirement - ServaCam uses MediaCodec (GLRecordingPipeline)
    ...
    private void showZoomRatioBottomSheet() {
        ...
        for (Float r : ratios) {
            items.add(new com.servalabs.cam.ui.picker.OptionItem(String.format(Locale.getDefault(), "%.1f", r),
    ...
    private void showVideoSplittingBottomSheet() {
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem("size", "Change Split Size (Current: " + sizeLabel + ")"));
        final String resultKey = "picker_result_video_split";
        getParentFragmentManager().setFragmentResultListener(resultKey, this, (k, b) -> {
            if (b.containsKey(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE)) {
                boolean state = b.getBoolean(com.servalabs.cam.ui.picker.PickerBottomSheetFragment.BUNDLE_SWITCH_STATE);
    ...
    private void showVideoSplitSizeBottomSheet() {
        ...
        for (int mb : presetMb) {
            if (mb == -1)
                items.add(new com.servalabs.cam.ui.picker.OptionItem("custom", "Custom..."));
            else
                items.add(new com.servalabs.cam.ui.picker.OptionItem(String.valueOf(mb),
    ...
    private void showCustomSplitSizeBottomSheet() {
        ...
        getParentFragmentManager().setFragmentResultListener(resultKey, this, (k, b) -> {
            if (b.containsKey(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER)) {
                int mb = b.getInt(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER);
