...
import com.servalabs.cam.utils.ChangelogParser;
...
public class UpdateAvailableBottomSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String tagUrl = args != null ? args.getString(ARG_TAG_URL, "https://github.com/anonfaded/ServaCam/releases/latest") : "https://github.com/anonfaded/ServaCam/releases/latest";
