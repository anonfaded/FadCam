...
public class AboutFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String currentTheme = sharedPreferencesManager.sharedPreferences.getString(com.servalabs.cam.Constants.PREF_APP_THEME, Constants.DEFAULT_APP_THEME);
    ...
    private void initializeViews() {
        ...
        String currentTheme = com.servalabs.cam.SharedPreferencesManager.getInstance(requireContext()).sharedPreferences.getString(com.servalabs.cam.Constants.PREF_APP_THEME, Constants.DEFAULT_APP_THEME);
    ...
    private void showLoadingDialog(String message) {
        requireActivity().runOnUiThread(() -> {
            ...
            String currentTheme = SharedPreferencesManager.getInstance(requireContext()).sharedPreferences.getString(com.servalabs.cam.Constants.PREF_APP_THEME, Constants.DEFAULT_APP_THEME);
    ...
    private MaterialAlertDialogBuilder themedDialogBuilder(Context context) {
        ...
        String currentTheme = spm.sharedPreferences.getString(com.servalabs.cam.Constants.PREF_APP_THEME, Constants.DEFAULT_APP_THEME);
        ...
        if ("Crimson Bloom".equals(currentTheme)) {
            ...
            dialogTheme = R.style.ThemeOverlay_ServaCam_Dialog;
        }
