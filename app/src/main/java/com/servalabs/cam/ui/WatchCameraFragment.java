 ...
 *
 * <p>Shows the ServaCam avatar eye toggle as the primary record/stop button,
...
public class WatchCameraFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // ServaCam logo click → open PrivacyBlackActivity if privacy mode is enabled
                ...
                try {
                    ...
                    if (sp.isPrivacyBlackModeEnabled()) {
                        android.content.Intent intent = new android.content.Intent(
                                requireContext(), com.servalabs.cam.ui.PrivacyBlackActivity.class);
        ...
        try {
            if (isRecording) {
                ...
                final Intent intent = new Intent(requireContext(),
                        com.servalabs.cam.PhotoCaptureActivity.class);
