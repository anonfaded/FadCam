...
public class NotificationSettingsFragment extends Fragment {
    ...
    private void showPresetPicker(){
        ...
        items.add(new com.servalabs.cam.ui.picker.OptionItem(SharedPreferencesManager.NOTIFICATION_PRESET_DEFAULT, getString(R.string.notification_preset_default)));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(SharedPreferencesManager.NOTIFICATION_PRESET_SYSTEM_UPDATE, getString(R.string.notification_preset_system_update)));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(SharedPreferencesManager.NOTIFICATION_PRESET_DOWNLOADING, getString(R.string.notification_preset_downloading)));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(SharedPreferencesManager.NOTIFICATION_PRESET_SYNCING, getString(R.string.notification_preset_syncing)));
        items.add(new com.servalabs.cam.ui.picker.OptionItem(SharedPreferencesManager.NOTIFICATION_PRESET_CUSTOM, getString(R.string.notification_preset_custom)));
    ...
    private void showHideStopBottomSheet(){
        ...
        java.util.ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new java.util.ArrayList<>(); // none, switch only
