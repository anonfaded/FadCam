...
public class AudioSettingsFragment extends Fragment {
    ...
    if(back!=null){ back.setOnClickListener(v -> com.servalabs.cam.ui.OverlayNavUtil.dismiss(requireActivity())); }
    ...
    private void showRecordAudioBottomSheet(){
        ...
        ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new ArrayList<>(); // No nested items now
        ...
        com.servalabs.cam.ui.picker.PickerBottomSheetFragment sheet = com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstanceWithSwitch(
    ...
    private void showMicSelectionBottomSheet(){
        ...
        for(int i=0;i<availableMicLabels.size();i++){
            ...
            items.add(new com.servalabs.cam.ui.picker.OptionItem(id, label));
        }
        ...
        com.servalabs.cam.ui.picker.PickerBottomSheetFragment sheet = com.servalabs.cam.ui.picker.PickerBottomSheetFragment.newInstance(
    ...
    private void showAudioAdvancedBottomSheet(){
        ArrayList<com.servalabs.cam.ui.picker.OptionItem> items = new ArrayList<>();
        items.add(new com.servalabs.cam.ui.picker.OptionItem("bitrate", getString(R.string.dialog_audio_bitrate_label)));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("sampling", getString(R.string.dialog_audio_sampling_rate_label)));
    ...
    private void showBitrateInputSheet(){
        ...
        getParentFragmentManager().setFragmentResultListener(rk, this, (k,b)->{
            if(b.containsKey(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER)){
                int br = b.getInt(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.RESULT_NUMBER);
    ...
    com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment sheet = com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.newInstance(
    ...
    if(sheet.getArguments()!=null){
        sheet.getArguments().putBoolean(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.ARG_SHOW_RESET, true);
        sheet.getArguments().putInt(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.ARG_DEFAULT_VALUE, 192000);
    sheet.getArguments().putString(com.servalabs.cam.ui.picker.NumberInputBottomSheetFragment.ARG_DESCRIPTION, getString(R.string.helper_audio_bitrate_detail) + "\n" + getString(R.string.audio_bitrate_recommended_line));
    }
    ...
    private void showSamplingRateInputSheet(){
        ...
        items.add(new com.servalabs.cam.ui.picker.OptionItem("44100", "44100 Hz" + (current==44100?"" : "")));
        items.add(new com.servalabs.cam.ui.picker.OptionItem("48000", "48000 Hz " + getString(R.string.label_recommended)));
