...
import com.servalabs.cam.ui.bottomsheet.ClientEventLogsBottomSheet;
...
public class ClientDetailsBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    private void addClientRow(LinearLayout container, String ip, int clientNumber) {
        ...
        com.servalabs.cam.streaming.RemoteStreamManager manager = com.servalabs.cam.streaming.RemoteStreamManager.getInstance();
        com.servalabs.cam.streaming.model.ClientMetrics metrics = manager.getClientMetrics(ip);
