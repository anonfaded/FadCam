...
public class TransportGraphWiringTest {
    ...
    public void directRelayAndTeardownFormOneExecutableGraph() throws Exception {
        ...
        try {
            ...
            // first physical connection until the direct-path assertions above
            // are complete, then wait for the controller itself to become
            // RELAYING. The transport-level latch can fire before the session
            // finishes authentication/registration and is therefore too early.
